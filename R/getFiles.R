...
getFiles <- function(
  ...
  wghfile="Derived/WGH_MGH/2019/RD03-99_ACDIS_WGH_ALL.dta",
  mghfile="Derived/WGH_MGH/2019/RD04-99_ACDIS_MGH_ALL.dta",
  ...
  fem_art="Derived/ARTemis/2017/ART_Females.csv",
  mal_art="Derived/ARTemis/2017/ART_Females.csv",
